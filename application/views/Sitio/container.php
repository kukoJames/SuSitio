			...
			<div class="col-lg-9">
				...
				<div class="row">
					...
					<div class="col-lg-4 col-md-6 mb-4">
						<div class="card h-100">
							<a href="#"><img class="card-img-top img-fluid" src="<?php echo base_url('assets/img/casa.JPG') ?>" alt=""></a>
							<div class="card-block">
					...
					<div class="col-lg-4 col-md-6 mb-4">
						<div class="card h-100">
							<a href="#"><img class="card-img-top img-fluid" src="<?php echo base_url('assets/img/home.JPG') ?>" alt=""></a>
							<div class="card-block">
					...
					<div class="col-lg-4 col-md-6 mb-4">
						<div class="card h-100">
							<a href="#"><img class="card-img-top img-fluid" src="<?php echo base_url('assets/img/domus.JPG') ?>" alt=""></a>
							<div class="card-block">
