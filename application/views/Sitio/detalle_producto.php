<script src="http://maps.google.com/maps/api/js?sensor=true"></script>
	<div class="container">
		<div class="row">
			<div class="col-lg-10 col-md-5 col-sm-2">

				<div class="row">
					<div class="col-lg-12 col-md-6 mb-4">
						<div class="card h-100">
							<a href="#" >
								<img class="card-img-top img-fluid" width="" height="" src="<?php echo base_url("{$producto->ruta_imagen}{$producto->nombre_imagen}") ?>"  alt="Mas información">
							</a>
