<?php
	function pasarMayusculas($letra) {
		$letra = strtoupper($letra);
		$letra = str_replace("á", "Á", $letra);
		$letra = str_replace("é", "É", $letra);
		$letra = str_replace("í", "Í", $letra);
		$letra = str_replace("ó", "Ó", $letra);
		$letra = str_replace("ú", "Ú", $letra);
